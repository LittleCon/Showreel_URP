#ifndef QC_DBUFFER_INCLUDED
#define QC_DBUFFER_INCLUDED
    ...
    inout half smoothness)
{
    ...
    baseColor.xyz =  decalSurfaceData.baseColor.w;
...
void ApplyDecalToSurfaceData(float4 positionCS, inout SurfaceData surfaceData, inout PreData preData)
{
