...
float4 frag(Varyings input) : SV_Target
{
    ...
    float texSize = _AlphaMapSize.x;//�߶�ͼ�Ŀ���
    float texNei = _AlphaMapSize.y;//�߶�ͼ���ȷ�֮һ
    ...
    // _BlendTexArray.Load(int3(uvInt1, 0)).r�൱��������������float��������
    //����blenderTex������ֻ�洢��16λ���ݣ����ǵ�16λ����float��32���ݣ��������ͨ������������0xFFFF����ȡ��16λ��Ϣ
    ...
    float2 uv1 = uvInt1 * texNei;//��������ӳ���uv����
    float2 uv2 = uvInt2 * texNei;//��������ӳ���uv����
    float2 uv3 = uvInt3 * texNei;//��������ӳ���uv����
    //���Ĳ�ֵ���㵱ǰ����Ȩ��
    ...
    for (i = 0; i < 8; i++)
        m[i] = float2(i, 0);
                ...
                {
                    height0 = SAMPLE_TEXTURE2D_ARRAY(_MinMaxHeightMap, sampler_MinMaxHeightMap, texUV, blend1.x).a;//�˴�Ӧ��ʹ��alpha8��HeightMap,��������AlbedoArray
                    height1 = SAMPLE_TEXTURE2D_ARRAY(_MinMaxHeightMap, sampler_MinMaxHeightMap, texUV, blend1.y).a;//�˴�Ӧ��ʹ��alpha8��HeightMap,��������AlbedoArray
                ...
                {
                    height0 = SAMPLE_TEXTURE2D_ARRAY(_MinMaxHeightMap, sampler_MinMaxHeightMap, texUV, blend2.x).a;//�˴�Ӧ��ʹ��alpha8��HeightMap,��������AlbedoArray
                    height1 = SAMPLE_TEXTURE2D_ARRAY(_MinMaxHeightMap, sampler_MinMaxHeightMap, texUV, blend2.y).a;//�˴�Ӧ��ʹ��alpha8��HeightMap,��������AlbedoArray
                ...
                {
                    height0 = SAMPLE_TEXTURE2D_ARRAY(_MinMaxHeightMap, sampler_MinMaxHeightMap, texUV, blend3.x).a;//�˴�Ӧ��ʹ��alpha8��HeightMap,��������AlbedoArray
                    height1 = SAMPLE_TEXTURE2D_ARRAY(_MinMaxHeightMap, sampler_MinMaxHeightMap, texUV, blend3.y).a;//�˴�Ӧ��ʹ��alpha8��HeightMap,��������AlbedoArray
